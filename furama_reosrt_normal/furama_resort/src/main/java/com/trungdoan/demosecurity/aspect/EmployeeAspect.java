...
public class EmployeeAspect {
    ...
    @After("execution(* com.trungdoan.demosecurity.controller.EmployeeController.save(..))")
    ...
    @After("execution(* com.trungdoan.demosecurity.controller.EmployeeController.update(..))")
    ...
    //
    @After("execution(* com.trungdoan.demosecurity.controller.EmployeeController.delete(..))")
    ...
    @AfterThrowing(value = "execution(* com.trungdoan.demosecurity.controller.EmployeeController.*(..))",throwing = "e")
