package com.trungdoan.demosecurity.aspect;//package com.baitap.validation.aspect;
...
public class CustomerAspect {
    ...
    @After("execution(* com.trungdoan.demosecurity.controller.CustomerController.save(..))")
    ...
    @After("execution(* com.trungdoan.demosecurity.controller.CustomerController.updateObject(..))")
...
//
@After("execution(* com.trungdoan.demosecurity.controller.CustomerController.delete(..))")
public void delete(JoinPoint joinPoint) {
    ...
    @AfterThrowing(value = "execution(* com.trungdoan.demosecurity.controller.CustomerController.*(..))",throwing = "e")
