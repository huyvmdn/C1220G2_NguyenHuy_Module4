...
public class CustomerController {
    ...
    public String updateObject(@ModelAttribute("object") Customer object, RedirectAttributes redirect) {
        if (object==null){
    ...
    public String save(@Valid  @ModelAttribute("object") Customer object, BindingResult bindingResult,Model model, RedirectAttributes redirect) {
        if (bindingResult.hasFieldErrors()) {
            model.addAttribute("flag",true);
            model.addAttribute("ok",bindingResult);
